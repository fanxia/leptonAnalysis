void qcdAnalyze() {
  ...
  TH1D * h_qcd_met = new TH1D("qcd_met", "qcd_met", 200, 0, 2000); h_qcd_met->Sumw2();
  TH1D * h_ttbar_met = new TH1D("ttbar_met", "ttbar_met", 200, 0, 2000); h_ttbar_met->Sumw2();
  TH1D * h_singleTop_met = new TH1D("singleTop_met", "singleTop_met", 200, 0, 2000); h_singleTop_met->Sumw2();
  TH1D * h_ttwz_met = new TH1D("ttwz_met", "ttwz_met", 200, 0, 2000); h_ttwz_met->Sumw2();
  TH1D * h_wjets_met = new TH1D("wjets_met", "wjets_met", 200, 0, 2000); h_wjets_met->Sumw2();
  TH1D * h_dyjets_met = new TH1D("dyjets_met", "dyjets_met", 200, 0, 2000); h_dyjets_met->Sumw2();
  TH1D * h_ttgjets_met = new TH1D("ttgjets_met", "ttgjets_met", 200, 0, 2000); h_ttgjets_met->Sumw2();
  TH1D * h_ttgg_met = new TH1D("ttgg_met", "ttgg_met", 200, 0, 2000); h_ttgg_met->Sumw2();
